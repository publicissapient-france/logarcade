            ...
            ['A', 'B', 'C', 'D']
                .forEach((button, i) => {
                    if (this.currentQuestion >= 0 && Phaser.Input.Keyboard.JustDown(this.buttons.P1[button])) {
                        this.onKeyDown(this.components.answers.texts[i], 2);
                        ...
                        this.onKeyDown(this.components.answers.texts[i], 1);
                        this.components.buttons.getFeedBack(button, Colors.color_P2);
                        this.nextQuestion();
                    }
